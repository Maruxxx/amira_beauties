...
function About() {
  return (
    <div className='flex flex-col justify-center items-center gap-8 my-20 md:flex-row-reverse md:justify-evenly relative'>

      <img src={require('../assets/icons/3.png')} className='hidden absolute w-[150px] right-0 top-10 -z-20 lg:block'></img>
      <img src={require('../assets/icons/4.png')} className='hidden absolute w-[150px] left-0 top-[200px] -z-40 lg:block'></img>
      
      <div className='flex flex-col justify-center items-center md:items-start md:w-1/3 gap-6'>
        
        <div className='flex justify-center items-center relative w-fit'>
          <p className='z-20 font-montserratMedium text-xl lg:text-2xl'>About us</p>
          <img src={require('../assets/icons/flower.png')} className='absolute right-0 z-10 w-[50px] lg:w-[60px]' alt=''></img>
        </div>
        ...
        <a className='px-8 py-3 bg-lightGold text-black font-montserratRegular lg:px-12 lg:py-4 lg:text-lg rounded-md text-sm cursor-pointer hover:scale-105 hover:bg-darkGold hover:text-white duration-150 ease-in-out transition-all'>
          Learn More
        </a>
