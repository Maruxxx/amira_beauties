...
function Presentation({color}) {
  return (
    <div className={`bg-${color} md:py-20 relative`}>     

      <img src={require('../assets/icons/1.png')} className='hidden absolute right-0 w-[150px] z-40 lg:block' alt=''></img>
      <img src={require('../assets/icons/2.png')} className='hidden absolute left-0 bottom-10 z-10 w-[150px] opacity-80 lg:block' alt=''></img> 
      ...
      <div className='flex flex-col justify-evenly items-center gap-8 sm:flex-row'>
          ...
          <div className='flex  flex-col justify-center items-start'>
            ...
            <div className='flex justify-center items-center gap-4 px-8 my-8 z-20'>
              ...
              <a href='/' className={`${color === 'pink' || color === 'darkGold' ? "bg-white" : "border border-black"} rounded-md py-2.5 w-36 text-center font-montserratBold text-sm md:w-44 md:py-3.5`}>Explore</a>
            </div>
          ...
          <div className='flex justify-end items-center animate-fade-left animate-ease-in-out'>
            {
              color === 'pink' || color === 'darkGold' ? (
                <img src={require('../assets/1-white.webp')} className='pl-4' alt=''></img>
                ) : (
